...
export default function Footer() {
  return (
    <div className="relative flex flex-col items-center justify-center gap-6 px-5 w-full bg-green-800 py-6 pt-10">
      <div className="first w-full flex flex-wrap items-start justify-between gap-6">
        ...
        <div className="intro flex flex-col gap-2 w-full lg:w-auto">
          <h1 className="text-[#48b543] text-2xl lg:text-3xl font-bold text-center lg:text-left">AGRIAID</h1>
          <p className="text-white text-center lg:text-left w-[300px]">
            Our vision is to provide convenience and help Farmers.
          </p>
        </div>


        <div className="text-white lists flex flex-wrap gap-6 justify-center lg:justify-between w-full lg:w-auto lg:mr-10">
          <div className="about">
      ...
      <div className="last w-full flex flex-wrap items-center justify-between gap-4">
        <div className="first text-center lg:text-left w-full lg:w-auto">
          <h1 className="font-bold text-sm">©2024 FERIXA. All rights reserved</h1>
        </div>
